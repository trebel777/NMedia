...
class PostDaoImpl(private val db: SQLiteDatabase) : PostDao {
    companion object {
        ...
        CREATE TABLE ${PostColumns.TABLE} (
            ...
            ${PostColumns.COLUMN_REPLYS} INTEGER NOT NULL DEFAULT 0,
    ...
    object PostColumns {
        ...
        const val COLUMN_REPLYS = "replys"
    ...
    override fun save(post: Post): Post {
        val values = ContentValues().apply {
            ...
            put(PostColumns.COLUMN_REPLYS, post.replys)
            put(PostColumns.COLUMN_VIDEO, "https://youtu.be/WhWc3b3KhnY")
        }
    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            return Post(
                ...
                replys = getLong(getColumnIndexOrThrow(PostColumns.COLUMN_REPLYS)),
